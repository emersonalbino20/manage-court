...
const Format = () => {
  ...
  const products = [
    { id: 1, name: 'Quadra de Futebol', price: 'Kz 89.000,90', image: Futebol_1, discount: '20%', location: 'Kilamba Kiaxe', rating: 4.5, type: 'futebol' },
    { id: 2, name: 'Quadra de Tênis', price: 'Kz 59.0000,90', image: Tenis_1, location: 'Talatona', rating: 3.5, type: 'tenis' },
    { id: 3, name: 'Quadra de Hóquei', price: 'Kz 35.000,90', image: Hoquei_1, discount: '15%', location: 'Viana', rating: 4.0, type: 'hoquei' },
    { id: 4, name: 'Quadra de Vôlei', price: 'Kz 159.000,90', image: Volei_1, location: 'Cacuaco', rating: 5.0, type: 'volei' },
    { id: 5, name: 'Quadra de Basquete', price: 'Kz 189.000,90', image: Basquete_1, discount: '10%', location: 'Belas', rating: 4.8, type: 'basquete' },
    { id: 6, name: 'Quadra de Hoquei', price: 'Kz 49.000,90', image: Hoquei_2, location: 'Kilamba Kiaxe', rating: 3.0, type: 'hoquei' },
    { id: 7, name: 'Quadra de Futebol', price: 'Kz 129.000,90', image: Futebol_2, location: 'Talatona', rating: 4.2, type: 'futebol' },
    { id: 8, name: 'Quadra de Tênis', price: 'Kz 39.000,90', image: Tenis_2, discount: '25%', location: 'Viana', rating: 3.8, type: 'tenis' },
  ];
